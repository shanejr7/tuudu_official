     ...
     findReply($item['user_id'],$index);
          ...
          $data.='<div class="media">
              ...
              $presignedUrl = (string)$request->getUri();
                ...
                <div class="media-body">
                  <button type="button" class="edit_post" data-id="'.$item['user_id'].'" data-username="'.$item['username'].'" data-key="'.$item['publickey'].'" data-time="'.$item['timestamp'].'" data-message="'.$item['message'].'"><h4 class="media-heading">'.$item['username'].'<small>&#xB7; '.$item['timestamp'].'</small></h4></button>
