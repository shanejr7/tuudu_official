...
$bucket_name = 'tuudu-official-file-storage';
 ...
 if (pg_num_rows($result) > 0) {
            ...
            if (isset($followerArr)) {
              ...
              <div class="name">
                <h6 class="title" style="display: inline-block; margin-right: 10px;">'.$item['username'].'</h6> <h16 style="font-size: 12px;"><a class="unfollow_user_btn" data-key="dummyString" data-userid="0" href="#"><span class="material-icons">remove_circle_outline</span></a></h16>
                </div>
            </div>';
                }else{
              ...
              <a href="#" class="unfollow_user_btn" data-key="dummyString" data-userid="0"><span class="material-icons">remove_circle_outline</span></a></form></h16>
                </div>
            </div>';
                }
