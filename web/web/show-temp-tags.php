...
if (isset($_SESSSION['id'])) {
		...
		$sql = "SELECT DISTINCT word_tag.event_type, itags.itagname FROM word_tag, feedstate WHERE word_tag.event_type = feedstate.word_tag AND feedstate.userid =$tagID";
