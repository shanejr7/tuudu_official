...
<nav class="navbar navbar-expand-lg bg-primary cd-section" id="nav">
 ...
 <?php 
                  ...
                  <a class="nav-link active" href="#home" role="tab" data-toggle="tab">
                    <b style="display: inline-block;margin-right: 5em;font-weight: 500;background-color:#e91e63">Latest Posts '.$posts_count['count'].'</b>
                 <b style="display: inline-block; margin-right: 2px;">Stats</b> </a>
                </li>';
                          }else{
                             echo '<li class="nav-item">
                  <a class="nav-link active" href="#home" role="tab" data-toggle="tab"><b   style="display: inline-block;margin-right: 5em;font-weight: 500;background-color:#e91e63">Latest Posts 0</b>
                 <b  style="display: inline-block; margin-right: 2px;">Stats</b></a>
                </li>';
                          }
