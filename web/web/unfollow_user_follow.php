...
$bucket_name = 'tuudu-official-file-storage';
	...
	WHERE user_id =$user_id AND user_following_id =$sid");
...
$result = pg_query($db, "SELECT id as user_following_id, username, email, profile_pic_src
 ...
 if (pg_num_rows($result) > 0) {
          ...
          if (isset($followingArr)) {
              ...
              <div class="name">
                <h6 class="title" style="display: inline-block; margin-right: 10px;">'.$item['username'].'</h6> <h16 style="font-size: 12px;"><a href="#" class="unfollow_user_follow_btn" data-key="dummyString" data-userid="'.$item['user_following_id'].'"><span class="material-icons">remove_circle_outline</span></a></h16>
                </div>
            </div>';
                }else{
